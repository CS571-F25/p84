		...
		<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
			{Array.from({ length: count }).map((_, i) => (
				<div
					...
					key={i}
					className="flex gap-4 p-4 bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-600 rounded-lg animate-pulse"
				>
					<div className="flex-shrink-0 w-16 h-[90px] bg-gray-200 dark:bg-zinc-700 rounded" />
					<div className="flex-1 min-w-0">
						{/* Handle */}
						<div className="h-5 w-24 bg-gray-200 dark:bg-zinc-700 rounded mb-1" />
						{/* Name */}
						<div className="h-7 w-40 bg-gray-200 dark:bg-zinc-700 rounded" />
						{/* Format */}
						<div className="h-5 w-20 bg-gray-200 dark:bg-zinc-700 rounded mt-1" />
						{/* Date */}
						<div className="h-5 w-28 bg-gray-200 dark:bg-zinc-700 rounded mt-2" />
					</div>
				</div>
			))}
		</div>
